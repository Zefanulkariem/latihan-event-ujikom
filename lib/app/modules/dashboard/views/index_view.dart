...
import 'package:event_latihan/app/modules/dashboard/views/add_view.dart';
import 'package:event_latihan/app/modules/dashboard/views/event_detail_view.dart';
        ...
        child: FutureBuilder<EventResponse>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.data!.events!.isEmpty) {
              return const Center(child: Text("Yah, Datanya engga!"));
            }
